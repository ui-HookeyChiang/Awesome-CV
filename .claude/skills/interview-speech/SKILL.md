...
# Interview Speech Script Rules

Use this skill when creating or editing interview speech scripts (`interview-speech.md` or `interview-speech-*.md`). This defines the structure, timing, and content guidelines for interview speaking notes.

## Speech Script Generation Process
The speech script is derived from interview-presentation.html and includes:
