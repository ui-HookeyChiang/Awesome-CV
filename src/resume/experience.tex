  ...
  \cventry
    ...
    {Mar. 2022 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item Dedicated to the very first Ubiquiti's NAS and its fundamentals,
          focusing on a cohesive storage solution.
          \begin{itemize}
          \item Accomplished NPI deliveries, factory test plans for AL524 SoC,
          ...
          \item Led the way for Linux upgrade from 4.19 to 5.10, resolving code
            ...
            packetdriller, and Phoronix Test Suite. Moreover, increased
            write iops by 40\% by applying the mq-deadline scheduler and
            Btrfs sync io.
          \item Unleashed a unidirectional Samba throughput of 830/930 MB/s
            over 10GbE by tuning the entire system, an increase from the initial
            download/upload speeds of 590/850 MB/s.
