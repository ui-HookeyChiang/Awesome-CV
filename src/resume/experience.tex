    ...
    {Mar. 2022 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item Dedicated to the very first Ubiquiti's NAS and its fundamentals,
          focusing on a cohesive storage service.
          \begin{itemize}
          \item Collaborated with cross-functional teams by sharing
            proposals, documents, code snippets, hence achieving NPI
            deliveries, test plans on Alpine AL524 and feature implementations,
            including file service, network discovery, data versioning, backup,
            integrity, migration on Debian.
          \item Upgraded Linux from 4.19 to 5.10, resolving code
            ...
            packetdriller, and Phoronix Test Suite. Additionally, increased
            write performance by 40\% by applying the mq-deadline scheduler and
            Btrfs sync io.
          \item Unleashed 800/900 MBs uni-directional Samba throughput over
            10GbE by tuning the entire system.
