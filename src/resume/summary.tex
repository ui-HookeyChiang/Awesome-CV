...
%---------------------------------------------------------
OS Engineer with 6+ years of diverse R\&D expertise in Linux development,
performance optimization, BSP porting, project planning, clean code practices
and quality assurance. Demonstrated success in the product release of UniFi
Network-Attached Storage (UNAS) and QNAP's cloud storage gateway.

Passionate about identifying problems and devising contextual methods.
Continuously learn and grow.
Happy to share knowledge, write technical documents and foster collaboration.

Had experience of C, C++, Go, Shell, SQL, gRPC, Docker, Jenkins, Linux, dpkg,
 Git and concurreny.
% reference
